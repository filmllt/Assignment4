    ...
    $scope.listFlight = [{
        ...
        "outbound": {
            ...
            },
            {
                ...
                "order": 2, "flightNO": "SU2460", "aircraftType": "Airbus320",
                "airline": "Aeroflot", "seatClass": "ECONOMY", "remainingSeats": 10
            }]
        }
    },
    {
        ...
        "outbound": {
            ...
            "price": 930.0,
            "takeOffFrom": "Suvanabhumi, Terminal",
            "takeOffTime": { "year": 2017, "month": 10, "dayOfMonth": 28, "hourOfDay": 23, "minute": 40, "second": 0 },
            "landingTo": "Paris-Charles-de-Gaulle, Terminal1A",
            "landingTime": { "year": 2017, "month": 10, "dayOfMonth": 29, "hourOfDay": 8, "minute": 30, "second": 0 },
            "transists": [{
                "fromAirport": "Suvanabhumi, Terminal",
                "toAirport": "Brisbane Airport, Terminal D",
                "order": 1, "flightNO": "TG930",
            ...
            },
            {
                ...
                "order": 2, "flightNO": "TG933", "aircraftType": "Airbus320",
                "airline": "Thai Airways", "seatClass": "BUSINESS",
                "remainingSeats": 10
            }]
        }
    }
